...
\noindent {\small\sf A. Integers and their number line.}
...
The  proof of Theorem~\ref{thm:Fund-Thm-Arith} goes beyond the scope
of this book.  We do discuss a number of applications of this
fundamental result.  We have already seen one application in
...
\noindent{\small\sf A. The basics of the complex numbers.}
%
...
\addcontentsline{toc}{paragraph}{B. Pairing functions:
  ordering $\C$ and $\N \times \N$}
\noindent{\small\sf B. Pairing functions: ordering $\C$ and $\N \times \N$.}
%
...
\addcontentsline{toc}{paragraph}{C. Binomial coefficients and Pascal's
triangle}
\noindent {\small\sf C. Binomial coefficients and Pascal's triangle}.
...
$\N$).  The binomial coefficient $\displaystyle {n \choose k}$ is the
number\index{binomial coefficients}
\begin{equation}
...
\begin{description}
\item[\small\sf Formation rule for Pascal's triangle:]
% 
